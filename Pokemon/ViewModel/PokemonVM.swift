...
//  Pokemon
//
//  Created by Developer on 13/12/2021.
//
...
//-------------------- Get Info ----------------------
    ...
    }//Número de Pokemons Adquiridos
    
    func NumberOfBattles() -> Int {
        model.Historico.count
    }//Número de Batalhas Realizadas
    ...
    }//Informação necessária para a Pokedex
    ...
    }//Informação necessária para o Historico
